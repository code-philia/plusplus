...
SYSTEM_FILES = (
    ...
    ("backend/src/runtime/ids.ts", "RUNTIME_IDS", "SKELETON_COMPILER"),
    ("backend/src/runtime/clock.ts", "RUNTIME_CLOCK", "SKELETON_COMPILER"),
    ("backend/src/runtime/stubs.ts", "RUNTIME_STUBS", "SKELETON_COMPILER"),
